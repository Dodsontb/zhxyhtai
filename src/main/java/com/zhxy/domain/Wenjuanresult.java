...
public class Wenjuanresult {
    ...
    public String getWenjuanresult() {
        return wenjuanresult;
    }

    public void setWenjuanresult(String wenjuanresult) {
        this.wenjuanresult = wenjuanresult;
    }

    public Integer getWenjuantype() {
        return wenjuantype;
    }
