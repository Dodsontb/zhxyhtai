...
public class Wenjuantimu {
    private Integer wenjuanid;

    private String wenjuantimu;
    ...
    public String getWenjuantimu() {
        return wenjuantimu;
    }

    public void setWenjuantimu(String wenjuantimu) {
        this.wenjuantimu = wenjuantimu;
    }
