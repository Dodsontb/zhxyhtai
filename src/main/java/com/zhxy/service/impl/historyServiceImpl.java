...
@Service
public class historyServiceImpl implements History_hxk{
	...
	@Override
	public int insertNotice(String headline, String ncontent, int TypeId, int uid) {
		// TODO Auto-generated method stub
		return mapper.insertNotice(headline, ncontent, TypeId, uid);
	}
